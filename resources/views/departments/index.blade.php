...
<div class="page-header">
    <h2 class="header-title">Department List</h2>
...
<div class="row">
    <div class="col-md-4">
        <div class="card">
            <div class="card-header mt-3 h4">{{ __('Add New Department') }}</div>
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('departments.store') }}" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control  @error('name') is-invalid @enderror" placeholder="Web Development" value="{{ old('name') }}" autocomplete="name" >
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{-- Edit and View --}}
                                    <a href="{{route('departments.edit', $item->id)}}" class="btn btn-icon btn-hover btn-sm btn-rounded pull-right text-primary">
                                    ...
                                    <form style="display: none;" id="delete-form{{$item->id}}" method="POST" action="{{route('departments.destroy', $item->id)}}" >
                                        @csrf @method('DELETE')
                                    </form>
